...
int main(void)
{
	...
	Assignment:
	Write a function with a string as parameter and an integer 1 (true) 
	...
	*/
	...
	printf("\n\t----\tDit is oefening 8.3 van 'Cprogrammingfundamentals2020' Pg129\t----\n\n\n\n");
	...
	printf("Write a Word please (and press enter) : => ");
	scanf("%s%*c", Word);

	Test_result = Test_Palindrome(Word);
...
int Test_Palindrome(char W[])
{
	int Test_var,word_length;
	Test_var = 1;
