...
int main(void)
{
	...
	Write a program that copies the text file from exercise 14.3 to a new 
...
void CopyFile(void)
{
	...
	{
		if (strcmp(Line,"\n") != 0) // Each empty line in the file will only have 1 caracter == the newline ("\n"). So each time we come across this type of line we skip it
		{
			fputs(Line, fd);
		}
